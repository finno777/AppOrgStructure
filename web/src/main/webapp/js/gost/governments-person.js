...
require(['SHARED/jquery', 'SHARED/jqueryUI', 'SHARED/gostFileManager'], function ($) {
    ...
    $(document).ready(function () {
        ...
        $('#personForm').on('submit', function (e) {
            ...
            var gonvermentId = +$('#personForm__governmentId').val();
            var id = +$('#personForm__personLinkId').val();
            ...
            preloader.show();
            window.dataService.saveGovernmentPerson(data).then(function (res) {
                preloader.hide();
...
//# sourceMappingURL=maps/governments-person.js.map
