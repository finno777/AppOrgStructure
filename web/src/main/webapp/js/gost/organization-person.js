...
require(['SHARED/jquery', 'SHARED/jqueryUI', 'SHARED/gostFileManager'], function ($) {
    ...
    $(document).ready(function () {
        ...
        $('#personForm').on('submit', function (e) {
            ...
            var orgId = +$('#personForm__organizationId').val();
            ...
            preloader.show();
            window.dataService.saveOrganizationPerson(data).then(function (res) {
                preloader.hide();
...
//# sourceMappingURL=maps/organization-person.js.map
